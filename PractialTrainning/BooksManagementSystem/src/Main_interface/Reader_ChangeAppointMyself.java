...
public class Reader_ChangeAppointMyself {
	public Reader_ChangeAppointMyself(String zhanghao) {
		initialize(zhanghao);
	...
	private void initialize(String zhanghao) {
		...
		JFrame jf = new JFrame("修改个人信息(直接在表格中修改)");
		...
		try {
			...
			for (int i = 0; rs.next(); i++) {
				...
				if (Integer.parseInt(zhanghao)==borrowid) {
